...
class ChillerRecordAdapter(
    private val records: List<ChillerRecord>,
    private val onDeleteClick: (ChillerRecord) -> Unit,
    private val maxTemp: Double = 0.0
) : RecyclerView.Adapter<ChillerRecordAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_chiller_record, parent, false)
