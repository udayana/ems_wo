...
class KwhtrChartView @JvmOverloads constructor(
    context: Context,
    ...
    private var records: List<KwhtrRecord> = emptyList()
    ...
    fun updateData(records: List<KwhtrRecord>) {
